#
# Module manifest for module 'Convert-LBFO2SET'
#
...
FunctionsToExport = 'Convert-LBFO2SET'
...
PrivateData = @{
    ...
    PSData = @{
        ...
        ProjectUri = 'https://github.com/microsoft/Convert-LBFO2SET'
